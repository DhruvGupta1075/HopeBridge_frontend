...
import { FaHome, FaSignOutAlt, FaUser, FaPills, FaBox } from 'react-icons/fa';
...
function DonorDashboard() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden dark bg-gray-900">
      {/* Navigation Bar */}
      <nav className="bg-gradient-to-r from-gray-800 to-gray-900 shadow-lg sticky top-0 z-50 w-full">
        <div className="w-full px-4 md:px-6 py-3 md:py-4">
          <div className="flex items-center justify-between max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              <Link
                to="/"
                className="flex items-center gap-1 md:gap-2 px-3 md:px-4 py-2 bg-white/20 hover:bg-white/30 text-white rounded-lg transition-all text-sm md:text-base"
              >
      ...
      <div className="w-full px-4 md:px-6 py-6 md:py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
          ...
          <Link to="/donor/signup" className="group">
            <div className="bg-gray-800 p-6 md:p-8 rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2 border border-gray-700">
              <div className="text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-2">Profile</h3>
                <p className="text-gray-300 text-xs md:text-sm">Manage your profile</p>
              </div>
            </div>
          </Link>
          ...
          <Link to="/donate/medicine" className="group">
            <div className="bg-gray-800 p-6 md:p-8 rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2 border border-gray-700">
              <div className="text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-2">Avail Med</h3>
                <p className="text-gray-300 text-xs md:text-sm">Donate medicines</p>
              </div>
            </div>
          </Link>
          ...
          <Link to="/listed-medicines" className="group md:col-span-2 lg:col-span-1">
            <div className="bg-gray-800 p-6 md:p-8 rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2 border border-gray-700">
              <div className="text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-2">Med Manager</h3>
                <p className="text-gray-300 text-xs md:text-sm">View all available medicines</p>
              </div>
            </div>
          </Link>
        </div>
        ...
        {/* Email Input Section */}
        {showEmailInput && (
          <div className="bg-gray-800 rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border border-gray-700 mt-6 md:mt-8">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4 md:mb-6">Enter Your Email</h2>
            ...
            <form onSubmit={handleEmailSubmit} className="space-y-3 md:space-y-0">
              <div className="flex flex-col md:flex-row gap-2 md:gap-2 md:max-w-md md:mx-auto">
                <input
                  ...
                  className="flex-1 px-3 md:px-4 py-2 md:py-3 border border-gray-600 rounded-lg bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                  required
                />
                <button
                  type="submit"
        ...
        <div className="bg-gray-800 rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border border-gray-700 mt-6 md:mt-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 md:mb-6">
            <h2 className="text-xl md:text-2xl font-bold text-white">Your Recent Donations</h2>
          ...
          {!userEmail || showEmailInput ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {donations.slice(0, 6).map((donation, index) => (
                <div key={index} className="bg-gray-700 p-4 md:p-6 rounded-lg md:rounded-xl border border-gray-600 hover:shadow-lg transition-all">
