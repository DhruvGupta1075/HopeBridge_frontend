...
import {
  FaHome, FaSignOutAlt, FaUserPlus, FaList, FaPills
} from "react-icons/fa";
...
export default function NeedyDashboard() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden dark bg-gray-900">
      {/* Navbar */}
      <nav className="bg-gradient-to-r from-indigo-700 to-purple-800 shadow-lg sticky top-0 z-50 w-full">
        <div className="w-full px-4 md:px-6 py-3 md:py-4">
          <div className="flex items-center justify-between max-w-7xl mx-auto">
            <div className="flex items-center gap-2 md:gap-3">
              <img src={logo} alt="MediHope Logo" className="h-8 w-8 md:h-10 md:w-10 rounded-full" />
              <h1 className="text-lg md:text-2xl font-bold text-white">
                <span className="hidden sm:inline">Needy </span>Dashboard
              </h1>
            </div>
      ...
      <div className="w-full px-4 md:px-6 py-6 md:py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
          <Link to="/needy/register" className="group">
            <div className="bg-gray-800 p-6 md:p-8 rounded-2xl shadow-lg border border-gray-700 hover:shadow-xl transition-all group-hover:-translate-y-2">
              <div className="text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-2">Register Needy</h3>
                <p className="text-gray-300 text-xs md:text-sm">Add new needy person</p>
              </div>
            </div>
          </Link>
          ...
          <Link to="/needy/list" className="group">
            <div className="bg-gray-800 p-6 md:p-8 rounded-2xl shadow-lg border border-gray-700 hover:shadow-xl transition-all group-hover:-translate-y-2">
              <div className="text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-2">View List</h3>
                <p className="text-gray-300 text-xs md:text-sm">All registered needy people</p>
              </div>
            </div>
          </Link>
          ...
          <Link to="/listed-medicines" className="group">
            <div className="bg-gray-800 p-6 md:p-8 rounded-2xl shadow-lg border border-gray-700 hover:shadow-xl transition-all group-hover:-translate-y-2">
              <div className="text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-2">Request Medicine</h3>
                <p className="text-gray-300 text-xs md:text-sm">Explore available medicines</p>
              </div>
            </div>
          </Link>
        </div>
        ...
        {/* Recent Medicines */}
        <div className="bg-gray-800 rounded-2xl shadow-lg p-4 md:p-6 border border-gray-700">
          <h2 className="text-xl md:text-2xl font-bold text-white mb-4 md:mb-6">Available Medicines</h2>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {medicineList.slice(0, 6).map((med, index) => (
                <div key={index} className="bg-gray-700 p-4 md:p-6 rounded-xl border border-gray-600 hover:shadow-lg transition-all">
                  <div className="flex items-start justify-between mb-3 md:mb-4">
                    <div className="flex-1 pr-2">
                      <h3 className="text-base md:text-lg font-bold text-white mb-2 break-words">{med.medicine}</h3>
